    ...
    public function store(Request $request)
{
    ...
    public function index()
    {
        ...
        return view('admin.mis.index', compact('misRecords', 'skippedKOs'));
    }
    ...
    public function destroy($id)
    {
        ...
        $record->delete();
        return redirect()->route('mis.index')->with('success', 'Record deleted successfully!');
    }
}
