...
<body>
    ...
    <div class="container mx-auto px-2">
            <div class="login-flex-box">
                <div class="login-box">   
                    <h2 class="text-center text-4xl font-semibold mb-5">Admin Register</h2>
                    ...
                    <p class="text-center">Haven't registered yet? <a href="{{ route('admin.login') }}" class="text-theme underline hover:opacity-75">Login</a></p>
                </div> 
            </div>
        </div>
